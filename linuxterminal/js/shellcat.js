function shellcat(param) {
    ...
    switch (param) {
        case 'skills.txt':
            containertext += '<div class="oldshell">[guest@razorgank ~] $ cat skills.txt</div>';
        ...
        case 'projects.txt':
            ...
            containertext += '<div class="oldshell">&nbsp;&nbsp;<b>slave-api</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Chikka API integration but on a queue-based workflow</div>';
        ...
        case 'services.txt':
            containertext += '<div class="oldshell">[guest@razorgank ~] $ cat services.txt</div>';
            ...
            break;
        case '':
            containertext += '<div class="oldshell">[guest@razorgank ~] $ cat </div>';
            containertext += '<div class="oldshell">cat: No page supplied to be opened</div>';
            break;
        default:
            containertext += '<div class="oldshell">[guest@razorgank ~] $ cat '+param+'</div>';
